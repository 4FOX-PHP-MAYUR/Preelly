...
const productSchema = new mongoose.Schema(
  {
    ...
    interiorColorId: { type: mongoose.Schema.Types.ObjectId, ref: 'Filter', default: null },
...
productSchema.index({ status: 1, location: 1 })
...
productSchema.index({ interiorColorId: 1 })
