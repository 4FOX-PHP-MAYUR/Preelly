...
function CategorySearchPage() {
  ...
  return (
    <div className="post-ad-step-shell-wide items-center">
      <button
        type="button"
        onClick={handleBack}
        className="mb-6 inline-flex self-start items-center gap-1 text-sm font-medium text-gray-500 hover:text-gray-800"
      >
