...
import { REJECTION_REASON_CATEGORIES } from '../constants/rejectionReasons'
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 min-h-[70vh]">
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm">Dashboard, product moderation, and user management</p>
      </div>

      <div className="space-y-6">
        {/* Right Side Main Content - fade on tab change */}
        <div key={activeTab} className="space-y-6 animate-fade-in min-w-0">
          {/* Stats Cards - modern grid */}
          {stats && (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              <Card title="Total Products" value={stats.totalProducts} icon={Package} />
              <Card title="Pending Review" value={stats.pendingProducts} icon={Clock} className="text-yellow-600" />
              <Card title="Approved" value={stats.activeProducts} icon={CheckCircle} className="text-green-600" />
              <Card title="Sold" value={stats.soldProducts} icon={TrendingUp} className="text-purple-600" />
            </div>
          )}

      {/* Search and Filters */}
      <div className="mb-6 admin-card bg-white rounded-xl shadow-sm border border-gray-100 p-4">
